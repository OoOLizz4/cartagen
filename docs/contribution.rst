...
To write the code needed to use the algorithm in QGis, you can use this :download:`module <https://raw.githubusercontent.com/LostInZoom/cartagen/refs/heads/main/docs/_static/creation_class_qgis.py>`_
